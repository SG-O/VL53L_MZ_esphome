...
public:
  ...
  uint8_t set_i2c_address(const uint16_t i2c_address) override { return vl53l5cx_set_i2c_address(&this->config_, i2c_address); }
  ...
  uint8_t get_default_i2c_address() override {
    return VL53L5CX_DEFAULT_I2C_ADDRESS >> 1;
  }
